...
typedef enum platform_key {
    ...
    PLATFORM_KEY_S, PLATFORM_KEY_D, PLATFORM_KEY_SPACE, PLATFORM_KEY_Q,
    PLATFORM_KEY_E, PLATFORM_KEY_C, PLATFORM_KEY_LEFT, PLATFORM_KEY_RIGHT,
    PLATFORM_KEY_ENTER, PLATFORM_KEY_I, PLATFORM_KEY_M, PLATFORM_KEY_COUNT
} platform_key;
 ...
 * cancelled. */
int platform_open_map_file_dialog(char* out_path,size_t out_path_size);
